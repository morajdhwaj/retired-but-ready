...
const Comments = (postId) => {
  ...
  const cards = [
    {
      ...
      time: "20 min ",
      paragraph:
        " It's fake so what?..Even For Credit cards were susceptible to such scanners where a guy would simply wave the scanner on your rear jeans pocket and card would be biled.",
      like: "Like | Reply",
    },
  ...
  return (
    <div className=" h-[100%]">
      {/* <div className="bg-[#FFFFFF] flex justify-between p-4 shadow-md  mt-20 sm:mt-20 md:mt-10 ">
      ...
      {cards.map((card, index) => (
        <div className=" mt-5 flex-row sm:flex " key={index}>
          <div>
