...
const Experiences = () => {
  return (
    <div className="h-full mx-12">
      ...
      Please indicate your english language proficiency with honesty.</h4>
      ...
      <div className="mt-5">
        ...
        <h4 className="text-gray-400 text-sm">Being multilingual is always a bonus.</h4>
        <br/>
      ...
      <div className="mt-5">
        ...
        <h3 className="text-[#BCC0C9] text-sm">This lets others know where you have worked and your wealth of expertise.</h3>
      </div>
      <div className="mt-10">
     ...
     <div className="flex justify-center items-center">
      <button className="text-xl text-[#773fc6] font-medium mt-10">+ ADD more positions</button>
     </div>
