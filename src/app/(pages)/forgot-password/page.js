  ...
  return (
    <div>
      ...
      <div className="bg-gray-200 flex h-auto">
        ...
        <div className="w-3/5 ">
          <div className="bg-white  pb-20 p-10 mr-20 ml-80 mt-10 mb-20">
            ...
            />
            <button className="bg-[#773FC6] text-white px-40 py-3 rounded-lg mt-8 w-full">
            ...
            <div className=" mt-3">
              ...
              <div className=" flex p-auto ">
                <input
                  ...
                  className="border border-gray-200 rounded-lg px-55 py-4 mt-2 text-xl"
                />
                <button className="bg-[#773FC6] rounded-lg  text-white mt-2 ml-20 w-full">
                  Send OTP
                </button>
              </div>
            </div>
